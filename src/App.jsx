...
function computeBondFlowsDelta(flows) {
  const delta = {};
...
function expandBondFlowsDelta(delta) {
...
function Chart100({series}){
  ...
  // Collect all dates across all series and build a shared timeline
  ...
  // Build per-series date→val maps for fast hover lookup
  ...
  // End-of-line labels — use last data point of each series
