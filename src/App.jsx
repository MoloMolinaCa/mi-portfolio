...
function CountdownDisplay({lastRefresh, priceStatus, liveCount, portLen}){
  ...
  if(priceStatus==="live") return <span style={{color:"var(--green)"}}> {liveCount}/{portLen} activos  actualizado {lastRefresh?.toLocaleTimeString("es-AR",{hour:"2-digit",minute:"2-digit"})}  prx. {Math.floor(display/60)}:{String(display%60).padStart(2,"0")}</span>;
...
const ASSET_TYPES = {
  ...
  fci_usd:   { label: "FCI Dlares",  color: "#A78BFA", icon: "" },
};
...
const GALICIA_PORTFOLIO = [
  ...
  // FCI USD
  { id:16, ticker:"FIMA-PREMD",name:"FIMA Premium Dlares Cl A",     type:"fci_usd",  qty:140.00,   buyPrice:1.012932,  currentPrice:1.012932, buyCurrency:"USD", rendPct:0.01,  buyDate:"2026-04-01" },
];
...
// ltimo da hbil (lunes-viernes) <= fecha dada
...
// Tickers se determinan dinmicamente desde el portfolio activo
...
const FCI_IDS = {
  ...
  "FIMA-PREMD": { fondo: "4", clase: "A", nombre: "FIMA Premium Dlares" },
};

//  Flujos de bonos preconfigurados 
// monto = % del VN segn prospecto (por cada 100 VN nominales)
// adjustsBy: variable que ajusta el capital/cupn ('CER', 'CER+TNA', null)
const SEED_BOND_META = {
  "TZXD6": {adjustsBy:"CER", emisionDate:"2022-03-15", cerBase:null, desc:"BONTES a Descuento CER V15/12/26  Cupn 0% + ajuste CER  Ley Argentina"},
  "TZX27": {adjustsBy:"CER", emisionDate:"2022-12-30", cerBase:null, desc:"BONO CER V30/06/27  Cupn 2% s/VN ajustado  Ley Argentina"},
  "AO27D": {adjustsBy:null,  desc:"Bono Tesoro 6% V29/10/27  Cupn mensual 6% anual base 30/360  Bullet al vencimiento  Ley Nueva York"},
  ...
  "TLCUD": {adjustsBy:null,  desc:"ON Telecom Argentina C28 05/03/29  Cupn 7% anual (3.5% semestral)  Ley Argentina"},
...
const SEED_BOND_FLOWS = {
  ...
  "TZX27": [
    // Cupn 2% sobre VN ajustado por CER, semestral
  ...
  "AO27D": [
    // Bono Tesoro 6% V29/10/27  cupn mensual, tasa 6% anual base 30/360
    // Amortizacin bullet al vencimiento (cupn 20  29/10/2027)
    // Cupn 1 (31/03/2026): cobrado. Cupn 2 en adelante: pendientes.
    {id:1006,date:"2026-03-31",tipo:"cupon",        monto:0.5667,cobrado:true, fechaCobro:"2026-03-31",fuente:"auto",nota:"das: 34  6%34/360"},
    {id:1007,date:"2026-04-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1008,date:"2026-05-29",tipo:"cupon",        monto:0.4833,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 29  6%29/360"},
    {id:1009,date:"2026-06-30",tipo:"cupon",        monto:0.5167,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 31  6%31/360"},
    {id:1010,date:"2026-07-31",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1011,date:"2026-08-31",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1012,date:"2026-09-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1013,date:"2026-10-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1014,date:"2026-11-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1015,date:"2026-12-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1016,date:"2027-01-29",tipo:"cupon",        monto:0.4833,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 29  6%29/360"},
    {id:1017,date:"2027-02-26",tipo:"cupon",        monto:0.4500,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 27  6%27/360"},
    {id:1018,date:"2027-03-31",tipo:"cupon",        monto:0.5833,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 35  6%35/360"},
    {id:1019,date:"2027-04-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1020,date:"2027-05-31",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1021,date:"2027-06-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1022,date:"2027-07-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1023,date:"2027-08-31",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1024,date:"2027-09-30",tipo:"cupon",        monto:0.5000,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 30  6%30/360"},
    {id:1025,date:"2027-10-29",tipo:"cupon",        monto:0.4833,cobrado:false,fechaCobro:null,        fuente:"auto",nota:"das: 29  6%29/360"},
  ...
  "GD38D": [
    ...
    // Amortizacin: 22 cuotas de 4.5455% (1/22) semestral desde jul/2027  ene/2038
    // Cupones 1-10 (2021-2025): ya cobrados antes de la posicin actual
    // Cupn 11 (13/07/2026): prximo pendiente
    ...
    // Desde c13: amort 4.5455% (1/22) + inters s/VN residual
    ...
    {id:1078,date:"2038-01-11",tipo:"amortizacion", monto:4.5454,cobrado:false,fechaCobro:null,fuente:"auto",nota:"4.5454% VN  cuota 22/22 (ltimo)"},
  ],
  "TLCUD": [
...
async function fetchFXLive() {
  ...
  return { ...FX_FALLBACK, source: "fallback", sourceNote: "Sin conexin  valores del 06/04/2026.", dateLabel: label, timeLabel: time };
}
...
async function fetchData912Prices(activeTickers=[]) {
  ...
  // Si activeTickers est vaco, guarda todos
  const parseD912 = (arr) => {
...
//  Yahoo Finance: fallback dinmico para cualquier ticker 
...
//  FCIs: argentinadatos.com va CAFCI 
...
// Para cada sub-perodo entre flujos, el retorno es valor_fin / valor_inicio.
// Los flujos no generan retorno  solo cambian la base del siguiente sub-perodo.
function calcTWR(dates, trades, en, tickerBars, cclBars, mepBars, currency, fxRate, livePricesMap, customEnd=null, realTodayStr=null){
  ...
  function findPrice2(bars,d){
    ...
    // Si no hay barra anterior, usar la primera disponible (inicio del histrico)
  ...
  const getPortVal=(dateStr, dateT)=>{
    ...
    return total; // puede ser 0 si no hay posicin an
  };
  ...
  for(let i=1;i<dates.length;i++){
    ...
    // Valor al cierre de ayer (posicin completa de ayer, precio de ayer)
    const valPrevClose=getPortVal(prevDateStr, prevDateT);

    // Valor de hoy CON la posicin de AYER (antes de cualquier flujo de hoy) al precio de HOY
    ...
    // Retorno del da = solo movimiento de precios, sin distorsin por flujos
    let dayReturn;
    if(valPrevClose<=0){
      // Portfolio vaco ayer  no hay retorno que calcular
      dayReturn=1;
    } else {
...
function EvoMini({en,trades,fxRate,liveT10Y,liveFX,liveSP500,historicos,isModal=false,livePricesAll={},onExpand=null}){
  const PERIODS=[{key:"mtd",label:"MTD",days:null,mtd:true},{key:"30d",label:"30d",days:30},{key:"90d",label:"90d",days:90},{key:"ytd",label:"YTD",days:null},{key:"1y",label:"1 ao",days:365},{key:"3y",label:"3 aos",days:1095}];
  // Persistir preferencias del grfico en localStorage
  ...
  const getDates=(p,hist,customStart=null,customEnd=null)=>{
    ...
    // Buscar el ltimo da hbil <= startStr (no el siguiente)
    ...
    // Agregar hoy siempre como ltimo punto
  ...
  const findPrice=(bars,dateStr)=>{
    ...
    // ltimo precio <= fecha (nunca usar precio futuro)
    let lo=0,hi=bars.length-1,res=-1;
    while(lo<=hi){
      const mid=(lo+hi)>>1;
  ...
  const load=async(p,hist,customStart=null,customEnd=null)=>{
    ...
    try{
      ...
      // Funcin que obtiene el precio de una barra, usando el valor live para hoy si est disponible
      ...
      if(currency!=="ARS"){
        // USD CCL / USD MEP: usar ndice S&P real en USD (historicos.sp500)
        // Para hoy: liveSP500 si est disponible, sino ltimo bar (no inventar con CEDEAR)
        ...
        // Fallback si no hay historicos S&P: CEDEAR SPY  TC (mismo TC para todos los das)
        ...
        // ARS: CEDEAR SPY en pesos  puro ARS, sin conversin
      ...
      if(currency==="ARS"&&t10yBars.length>=2){
        ...
        // Cada da: rendimiento = (1 + tasa_diaria/100)^das_acumulados
        ...
        // Fallback sinttico si no hay datos
  ...
  const xirrData=useMemo(()=>{
    ...
    try{
      ...
      // Period trades: EXCLUIR trades del dia e para evitar doble conteo (ya estan en endValUSD)
...
const AR_TICKERS = {
  ...
  BYMA:"Bolsas y Mercados Arg.",CEPU:"Central Puerto",PAMP:"Pampa Energa",TGSU2:"Transportadora Gas Sur",
  TGNO4:"Transportadora Gas Norte",COME:"Sociedad Comercial del Plata",LOMA:"Loma Negra",
  ALUA:"Aluar Aluminio",CRES:"Cresud",IRSA:"IRSA",MOLI:"Molinos Ro de la Plata",
  RICH:"Laboratorios Richmond",HARG:"Holcim Argentina",EDN:"Edenor",TECO2:"Telecom Argentina",
  METR:"Metrogas",GARO:"Garovaglio y Zorraqun",AGRO:"AgroEtanol",BOLT:"Boldt",
  // CEDEARs populares
  ...
  VIST:"Vista Oil & Gas",YPF:"YPF S.A. (ADR)",PAM:"Pampa Energa (ADR)",
  // Bonos soberanos ARS
    ...
    <div>
      ...
      <div style={{position:"relative"}}>
        <input
          ...
          placeholder="Escrib para filtrar (ej: AAPL, GD...)"
...
function inferType(item, endpoint){
  ...
  if(endpoint==="arg_bonds"||endpoint==="arg_corp"){
    ...
    // No usar descripcin  bonos CER como TZX28 dicen "U$S" pero son ARS
...
// Paso 2: si no  preguntar parmetros y generar flujos
function BondWizard({ticker, onConfirm, onSkip, darkMode=true}){
  ...
  // Avanzar al siguiente da hbil (lunes-viernes, sin feriados AR)
  // Usar T12:00:00 para evitar desfase UTC en timezones negativas (Argentina UTC-3)
  const nextBusinessDay = async (dateStr) => {
    const d = new Date(dateStr + 'T12:00:00');
    for(let i=0;i<20;i++){
      // getDay() sobre fecha con hora local  da correcto en Argentina
      const dow = d.getDay();
  ...
  const [params, setParams] = useState({
    ...
    cuotas: '',
    emisionDate: '',
    primerCupon: '', // fecha exacta del primer cupn (YYYY-MM-DD)  el schedule se proyecta desde ac
    base: '30/360',  // base de clculo: '30/360' | 'dias/365'
  ...
  //  Helpers de clculo (mirror de FlujoTab) 
  ...
  //   dateCalc: fecha terica (para clculo de das/intereses, puede ser inhbil)
  //   datePago: siguiente da hbil (fecha efectiva de cobro)
  const generateRows = async () => {
    ...
    // Da del mes del primer cupn  se repite en cada perodo
    const diaNum = firstDate.getDate();

    // Pre-cargar feriados de todos los aos involucrados
    ...
    // Generar fechas tericas (dateCalc): primer cupn + freqMonths sucesivos, mismo da
    const calcDates = [primerCupon]; // primera fecha exacta como la ingres el usuario
    ...
    // Asegurar que el vto est incluido al final
    ...
    // datePago: siguiente da hbil de cada dateCalc (vto no se ajusta)
    ...
    let vnResidual = 100;
    // Clculo de das usa fechas TERICAS (dateCalc), empezando desde la emisin
  ...
  // date = datePago (hbil), dateCalc guardado en nota para referencia
  ...
  return(
    <div className={darkMode?"theme-dark":"theme-light"} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.88)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300}}>
      <div style={{background:"var(--bg-card)",border:"1px solid var(--border)",borderRadius:16,padding:28,width:560,maxWidth:"95vw",maxHeight:"90vh",overflowY:"auto"}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
          <div>
            ...
            <p style={{fontSize:11,color:"var(--text-muted)",margin:"4px 0 0"}}>
              {step==='confirm' ? 'Encontr el schedule en el sistema. Confirm antes de cargar.' :
               step==='params'  ? 'No encontr el schedule. Ingres los parmetros para generarlo.' :
               'Revis los flujos generados antes de confirmar.'}
            </p>
          </div>
                ...
                <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
                  <thead>
                    <tr style={{borderBottom:"1px solid var(--border)"}}>
                      {hasDualDates
                        ? [
                            <th key="fc" style={{padding:"6px 8px",textAlign:"left",fontSize:10,color:"var(--text-muted)",fontWeight:600,textTransform:"uppercase"}}>F. Clculo</th>,
                      ...
                      <tr key={i} style={{borderBottom:"1px solid var(--border)"}}>
                        ...
                        <td style={{padding:"6px 10px"}}>
                          <span style={{color:f.tipo==='amortizacion'?"var(--yellow)":"var(--accent)",fontWeight:600}}>
                            {f.tipo==='amortizacion'?' Amort.':' Cupn'}
                          </span>
                        </td>
        ...
        {step==='params' && (
          <>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:16}}>
              <div>
                <span style={lbl}>Fecha de emisin</span>
              ...
              <div>
                <span style={lbl}>Frecuencia de cupn</span>
              ...
              <div>
                <span style={lbl}>Fecha del 1er cupn</span>
                ...
                <span style={{fontSize:10,color:"var(--text-muted)",marginTop:3,display:"block"}}>
                  Fecha terica  el resto se proyecta desde ac  das hbiles ajustados automtico
                </span>
              </div>
              <div>
                <span style={lbl}>Base de clculo</span>
                <select value={params.base} onChange={e=>set('base',e.target.value)} style={inp}>
                  <option value="30/360">30/360</option>
                  <option value="dias/365">Das / 365</option>
                </select>
              </div>
              <div>
                <span style={lbl}>Amortizacin</span>
        ...
        {/* PASO: REVIEW  una fila por fecha, columnas Fecha/Amort/Cupn editables */}
          ...
          <>
            {!amortOk&&(
              <div style={{background:"rgba(248,113,113,0.1)",border:"1px solid rgba(248,113,113,0.3)",borderRadius:7,padding:"7px 12px",marginBottom:10,fontSize:12,color:"var(--red)"}}>
                 Amortizacin total: <b>{totalAmort.toFixed(4)}%</b>  debe ser exactamente 100%
              </div>
            )}
            {amortOk&&(
              ...
              <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
                <thead>
                  <tr style={{borderBottom:"1px solid var(--border)",position:"sticky",top:0,background:"var(--bg-card)"}}>
                    <th style={{padding:"6px 8px",textAlign:"left",fontSize:10,color:"var(--text-muted)",fontWeight:600,textTransform:"uppercase",minWidth:110}}>F. Clculo</th>
                    ...
                    <th style={{padding:"6px 8px",textAlign:"right",fontSize:10,color:"var(--accent)",fontWeight:600,textTransform:"uppercase",minWidth:80}}>Cupn %</th>
            ...
            <div style={{display:"flex",gap:10,justifyContent:"space-between",alignItems:"center"}}>
              <button onClick={()=>setStep('params')} style={{...btn("var(--bg-input)"),color:"var(--text-muted)",border:"1px solid var(--border)",fontSize:12}}> Parmetros</button>
  ...
  return(
    <div className={darkMode?"theme-dark":"theme-light"} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:200}}>
      <div style={{background:"var(--bg-card)",border:"1px solid var(--border)",borderRadius:16,padding:28,width:520,maxWidth:"95vw",maxHeight:"90vh",overflowY:"auto"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
          <h3 style={{fontFamily:"Georgia,serif",fontSize:16,color:"var(--text-primary)",margin:0}}>{h?"Editar posicin":"Nueva posicin"}</h3>
        ...
        <div style={{display:"grid",gap:14}}>
          {/* TOGGLE COMPRA/VENTA */}
          <div>
            <span style={{fontSize:10,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1,display:"block",marginBottom:6}}>Operacin</span>
            ...
            {f.operacion==="venta"&&<div style={{fontSize:11,color:"var(--yellow)",marginTop:5}}> FIFO  salen los lotes ms antiguos primero</div>}
          </div>
          ...
          {f.operacion==="venta"?(
            ...
            <div>
                ...
                {searchResults.length>0&&(
                  <div style={{position:"absolute",top:"100%",left:0,right:0,background:"var(--bg-card)",border:"1px solid var(--border)",borderRadius:8,zIndex:50,maxHeight:280,overflowY:"auto",marginTop:4,boxShadow:"0 8px 24px rgba(0,0,0,0.5)"}}>
                    <div style={{padding:"6px 12px",fontSize:10,color:"var(--text-muted)",borderBottom:"1px solid var(--border)",textTransform:"uppercase",letterSpacing:1}}>
                      {searchResults.length} instrumento{searchResults.length!==1?"s":""} encontrado{searchResults.length!==1?"s":""}  seleccion el que quers dar de alta
                    </div>
              ...
              {tickerStatus==="notfound"&&<div style={{marginTop:8,background:"rgba(251,191,36,0.07)",border:"1px solid rgba(251,191,36,0.2)",borderRadius:8,padding:"10px 12px",fontSize:12,color:"var(--yellow)"}}> Sin resultados en data912 ni Yahoo  pods guardar igual ingresando los datos manualmente.</div>}
            </div>
          )}
          ...
          <label style={{display:"flex",flexDirection:"column",gap:4}}>
            ...
            <input value={f.name} onChange={e=>set("name",e.target.value)} placeholder="Se completa automtico al seleccionar" style={inp}/>
          </label>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 2fr",gap:12}}>
            <label style={{display:"flex",flexDirection:"column",gap:4}}>
              ...
              {f.operacion==="venta"&&f.ticker&&<div style={{fontSize:10,color:overSelling?"var(--red)":"var(--text-muted)",marginTop:3}}>
                {overSelling?` Solo tens ${availableQty.toLocaleString("es-AR")} nominales`:`Disponible: ${availableQty.toLocaleString("es-AR")} nominales`}
              </div>}
            </label>
              ...
              {(()=>{
                ...
                return (<>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8,gap:8}}>
                    <span style={{fontSize:11,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1,flexShrink:0}}>Comisin</span>
        ...
        <div style={{display:"flex",gap:10,marginTop:22,justifyContent:"space-between",alignItems:"center"}}>
          {h&&<button onClick={()=>{if(window.confirm("Eliminar esta posicin?"))onSave(null);}} style={{padding:"8px 14px",background:"rgba(248,113,113,0.1)",border:"1px solid rgba(248,113,113,0.3)",borderRadius:8,color:"var(--red)",cursor:"pointer",fontSize:12}}> Eliminar</button>}
          {!h&&<div/>}
...
function EvoTab({en,trades,totUSD,totPct,benchPct,alpha,liveT10Y,byType,card,fxRate,fx,historicos}){
  const PERIODS=[
    ...
    {key:"1y",  label:"1 ao",days:365},
    {key:"3y",  label:"3 aos",days:1095},
  ];
  ...
  const getDates = (p, n=30) => {
    ...
    // La fecha de inicio es el mximo entre el perodo y la primera compra
    const firstBuy = trades.filter(t=>t.tipo==="compra").sort((a,b)=>a.date.localeCompare(b.date))[0]?.date;
    const firstBuyDate = firstBuy ? new Date(firstBuy) : end;
    const start = firstBuyDate > periodStart ? firstBuyDate : periodStart;
  ...
  //  Fetch SPY histrico USD  spark endpoint Yahoo (CORS ok en browser) 
  //  Fetch SPY histrico via proxy Vercel (sin CORS) 


  //  Encontrar el CCL ms cercano a una fecha 
  ...
  //  Interpolador: precio ms cercano a una fecha 
  const findPrice = (bars, dateStr) => {
    if(!bars||!bars.length) return null;
    const t = new Date(dateStr).getTime();
  ...
  const load = async (p, hist) => {
    ...
    // Usar hist pasado explcitamente para evitar closures obsoletos
    const _hist = hist || historicos || {};
    const _getCCL  = () => _hist.CCL  || [];
    const _getMEP  = () => _hist.MEP  || [];
    const _getSPY  = () => _hist.sp500 || [];
    ...
    try {
      ...
      // SPY benchmark base-100  convertido segn moneda seleccionada
      let spy100 = null, spySource = "sin datos";
      // S&P500: usar historicos.sp500 (yfinance USD) si est disponible,
      ...
      if(sp500Bars.length >= 2 && currency!=="ARS"){
        ...
        // SPY.BA en ARS desde BYMA, convertido segn moneda
      ...
      // T10Y base-100  usar datos reales del histrico si existen
      ...
      // Histrico por ticker desde JSON pre-generado
      const allTickers = [...new Set(en.map(h=>h.ticker))];
      const tickerBars = {};
  ...
  useEffect(()=>{
    // Solo cargar cuando historicos est disponible (no null ni vaco)
    if(!historicos || Object.keys(historicos).length === 0) return;
    const p=PERIODS.find(x=>x.key===period);
  ...
  return(
    <div className="fi" style={{display:"grid",gap:14}}>
      ...
      {/* Contribucin por tipo */}
      <div style={{...card,padding:20}}>
        <div style={{fontSize:10,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1,marginBottom:14}}>Contribucin por tipo de activo</div>
...
function PortfolioTab({byType,en,totUSD,totCost,totPnl,totPct,fxRate,fxMode,setModal,del,card,hideAmounts=false,trades=[],historicos={},isMobile=false}){
  ...
  // Helper: encontrar TC histrico ms cercano a una fecha
  ...
  const renderRow=(h)=>{
    ...
    // Costo en ARS usando TC histrico de cada lote de compra
    // Para activos USD: suma cada lote  precio_compra  TC_del_dia_de_compra
    // Para activos ARS: el costo ya est en ARS
    ...
    if(isUSD){
      ...
      costARSHist=origCost; // ya est en ARS
    }
    ...
    // Costo en USD usando TC histrico de cada lote
    // Para activos ARS: suma cada lote  TC_del_dia_de_compra
    // Para activos USD: el costo ya est en USD
    let costUSDHist=0;
    if(!isUSD){
      for(const lot of buyLots){
        const lotFactor=isBond?lot.qty/100:lot.qty;
      ...
      costUSDHist=origCost; // ya est en USD
    }
          ...
          <div key={`section-${t.key}`} style={{...card,overflow:"hidden"}}>
            ...
            <div style={{padding:"12px 16px",borderBottom:"1px solid var(--border)",display:"flex",justifyContent:"space-between",alignItems:"center",background:'transparent',flexWrap:isMobile?"wrap":"nowrap",gap:8}}>
              <div style={{display:"flex",alignItems:"center",gap:10}}>
                ...
                <span style={{fontSize:11,color:"var(--text-muted)"}}> {items.length} posicin{items.length!==1?"es":""}</span>
              </div>
...
function OperacionesTab({trades,port,setTrades,setPort,card,livePrices,darkMode}){
  ...
  const saveEdit=()=>{if(!window.confirm("Confirmar modificacion?"))return;
    ...
    // Recalcular buyPrice del port si cambi
  ...
  const deleteTrade=(trade)=>{
    ...
    if(netQty<=0){
      // Sin posicin neta  eliminar del portfolio
      ...
      setPort(prev=>{
        ...
        if(exists){
          ...
          // La posicin no estaba en el portfolio  restaurar
          const firstBuy=[...remaining].sort((a,b)=>a.date.localeCompare(b.date))[0];
          // Inferir type desde el ticker si no est disponible
    ...
    <div className="fi" style={{display:"grid",gap:14}}>
      ...
      <div style={{...card,padding:"14px 16px",display:"flex",gap:12,flexWrap:"wrap",alignItems:"flex-end"}}>
        ...
        <span style={{fontSize:11,color:"var(--text-muted)",marginLeft:"auto",alignSelf:"flex-end"}}>
          {sorted.length} de {trades.length} operacin{trades.length!==1?"es":""}
        </span>
      </div>
      ...
      {confirmDelete&&(
        <div className={darkMode?"theme-dark":"theme-light"} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300}}>
          <div style={{background:"var(--bg-card)",border:"1px solid var(--border)",borderRadius:16,padding:28,width:420,maxWidth:"95vw"}}>
            <div style={{fontFamily:"Georgia,serif",fontSize:16,fontWeight:700,marginBottom:12}}>Eliminar operacin?</div>
            ...
            <div style={{fontSize:12,color:"var(--yellow)",marginBottom:20}}> Esta accin elimina la operacin del historial. Si era la nica compra del activo, se elimina del portfolio.</div>
            <div style={{display:"flex",gap:10,justifyContent:"flex-end"}}>
  ...
  return(
    <div>
      ...
      <div style={{padding:"5px 16px",fontSize:9,color:"var(--text-muted)",borderTop:"1px solid var(--border)"}}>
        Rendimiento del instrumento en el perodo  dolarizado a {dolarLabel}
      </div>
    </div>
  );
}
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
      <div style={{...card,overflow:"hidden"}}>
        <div style={{padding:"10px 14px",borderBottom:"1px solid var(--border)",display:"flex",alignItems:"center",gap:8,background:"rgba(52,211,153,0.08)"}}>
          <span></span>
          <span style={{fontWeight:700,fontSize:12,color:"var(--green)"}}>Top 5  Mejores del da</span>
        </div>
      ...
      <div style={{...card,overflow:"hidden"}}>
        <div style={{padding:"10px 14px",borderBottom:"1px solid var(--border)",display:"flex",alignItems:"center",gap:8,background:"rgba(248,113,113,0.05)"}}>
          <span></span>
          <span style={{fontWeight:700,fontSize:12,color:"var(--red)"}}>Bottom 5  Peores del da</span>
        </div>
...
function AnalisisTab({en, historicos, fxRate, currency, card, livePrices, hideAmounts=false, trades=[], isMobile=false}) {
  const PERIODS_AN = [
    {key:"todo",  label:"Todo el perodo", days:null, start:"2026-01-01"},
    {key:"ytd",   label:"YTD",             days:null, ytd:true},
    {key:"90d",   label:"90 das",          days:90},
    {key:"30d",   label:"30 das",          days:30},
  ];
  ...
  // Calcular fecha de inicio del perodo
  ...
  // Calcular retorno de un activo en el perodo
  ...
  const calcExtremes = (bars, start, end) => {
    ...
    // Max Drawdown: cada desde un pico hasta el valle subsiguiente
    ...
    // Das de recuperacin: desde el trough hasta que vuelve al nivel del pico
    if(ddTrough){
  ...
  // Portfolio TWR  misma lgica que el grfico principal
  // portSeries: calcular sin precios live para no recalcular al llegar precios
  // Los precios live solo afectan el ltimo punto, no todo el histrico
  ...
  // Contribucin al rendimiento  considera tenencia real en el perodo
  const contributions = useMemo(()=>{
    ...
    // Helper: precio ms cercano a una fecha  biseccin O(log n)
    const closestPrice = (bars, dateStr) => {
      if(!bars||!bars.length) return null;
      // Biseccin para encontrar el ltimo bar <= dateStr
      let lo=0, hi=bars.length-1, res=-1;
      while(lo<=hi){
        const mid=(lo+hi)>>1;
    ...
    // Todos los tickers activos en el perodo: los que tengo hoy + los que tuve y vend
    const tickersHoy = new Set(en.map(h=>h.ticker));

    // Detectar todos los tickers que tuve en algn momento pero ya no tengo
    // Un activo debe aparecer si:
    //   a) tuvo trades dentro del perodo, O
    //   b) tena posicin al inicio del perodo (lo compr antes y vend antes o durante)
    ...
    const tickersCerrados = allTradeTickers.filter(ticker=>{
      // Tuvo posicin en algn momento del perodo [startDate, endDate]?
      ...
      // Fecha de primera compra y ltima venta
    ...
    // Construir lista completa: posiciones actuales + cerradas en el perodo
    const posicionesCerradas = tickersCerrados.map(ticker=>{
      ...
      // Convencin BYMA: bonos USD terminan en D, bonos ARS sin D pero con suffix numrico
      const isBondTicker = /\d/.test(ticker); // tiene nmero  probablemente bono
    ...
    // Reconstruir qty de cada ticker al inicio del perodo desde trades
    // Usar <= startDate para incluir los comprados el mismo da de inicio
    // cashCompras/cashVentas excluirn esos trades usando > startDate
    const qtyAtStart = {};
    ...
    return todasPosiciones.map(h=>{
      ...
      // Qty al inicio del perodo (puede ser 0 si fue comprado despus)
      const qtyStart = qtyAtStart[h.ticker]||0;
      // Qty actual (la de en[])
      const qtyEnd = h.qty;

      // Si no tena nada al inicio Y no compr durante el perodo  saltar
      if(qtyStart===0 && qtyEnd===0) return null;

      // Precio base: si tena posicin al inicio  usar precio histrico del startDate
      //              si compr durante el perodo  usar precio promedio de compras del perodo
      let basePrice, baseDate, usedBuyPrice=false, qtyBase;

      if(qtyStart > 0){
        // Tena posicin al inicio  base = precio al startDate
        ...
        // Comprado durante el perodo  base para retPct = precio histrico al inicio si existe
        // (para mostrar cmo se movi el activo en el perodo aunque no lo tuvieras)
        ...
        if(startPrice2){
          ...
          // Sin historial  usar primer precio de compra del perodo
        ...
        qtyBase = 0; // no tena posicin al inicio  valInicio = 0
      ...
      // Rend. %: rendimiento del precio en el perodo (siempre precio base  precio actual)
      const retPct = ((adjClose - adjBase)/adjBase)*100;

      // P&L real del perodo usando flujos de caja:
      // P&L = valor_final - valor_inicial - compras_del_perodo + ventas_del_perodo
      ...
      // Valor al inicio del perodo (qtyStart  precio al inicio)
      const valInicio = qtyStart>0 ? toCCL(adjBase, baseDate) * qtyFactor(qtyStart) : 0;

      // Valor al final del perodo (qtyEnd  precio actual)
      const valFinal = toCCL(adjClose, endDate) * qtyFactor(qtyEnd);

      // Compras durante el perodo (cash saliente  resta)
      // Usar > startDate para no doble-contar compras del da inicial (ya en qtyAtStart)
      ...
      // Ventas durante el perodo (cash entrante  suma)
      // Usar > startDate para no doble-contar ventas del da inicial
      ...
      if(h.cerrado){
        // Calcular qty total operada en el perodo para el rend %
        ...
        if(valInicio===0 && cashCompras>0 && cashVentas>0){
          // Comprado y vendido dentro del perodo
          ...
          // Tena al inicio y vendi: rend del precio desde inicio
  ...
  // Distribucin de retornos diarios del portfolio
  ...
  // Mobile: tabs de seccin
  const MOBILE_SECTIONS = [
    {k:"contribucion", l:"Contribucin"},
    {k:"extremos", l:"Extremos"},
    {k:"retornos", l:"Retornos"},
    {k:"correlacion", l:"Correlacin"},
  ];
  ...
  return(
    <div className="fi" style={{display:"grid",gap:isMobile?10:16}}>
      ...
      {!isMobile&&<div style={{fontSize:10,color:"rgba(96,165,250,0.6)",textTransform:"uppercase",letterSpacing:1,marginBottom:-8}}> Aplica filtro de perodo</div>}
            ...
            {ex ? (
              <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:10}}>
                ...
                <div style={{background:"rgba(248,113,113,0.07)",border:"1px solid rgba(248,113,113,0.2)",borderRadius:8,padding:"12px 14px"}}>
                  <div style={{fontSize:9,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Mayor cada</div>
                  ...
                  <div style={{fontSize:10,color:"var(--text-muted)",marginTop:3}}>
                    {ex.ddDays} das de cada
                  </div>
                  {ex.recDays!=null
                    ? <div style={{fontSize:10,color:"var(--green)",marginTop:3}}> Recuper en {ex.recDays} das</div>
                    : ex.ddTrough ? <div style={{fontSize:10,color:"var(--yellow)",marginTop:3}}> Sin recuperar an</div> : null
                  }
                </div>
                {/* Mayor rally */}
      ...
      {(!isMobile||mobileSection==="contribucion")&&<div style={{...card,padding:isMobile?"10px 12px":"16px 20px"}}>
        {sectionTitle("Contribucin al rendimiento  " + (selP.key==="todo"?"desde precio de compra":"rendimiento del perodo"))}
        ...
        <div style={{overflowX:"auto"}}>
          ...
          <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
            <thead>
              <tr style={{borderBottom:"1px solid var(--border)"}}>
                ...
                <SortTh col="contrib" label="Contribucin"/>
                  ...
                  <tr key={h.ticker} style={{borderBottom:"1px solid rgba(255,255,255,0.04)"}}>
                    ...
                    {selP.key!=="todo"&&(
                      <td style={{padding:"8px 12px",textAlign:"right",fontSize:10}}>
                        ...
                        {h.usedBuyPrice&&<span title="Sin historial para este perodo  se us precio de compra" style={{marginLeft:4,color:"var(--yellow)",fontSize:9}}>pc</span>}
                      </td>
                    )}
          ...
          {selP.key!=="todo" && contributionsSorted.some(h=>h.usedBuyPrice) && (
            <div style={{marginTop:8,fontSize:11,color:"var(--yellow)",display:"flex",gap:6,alignItems:"center"}}>
              <span>pc</span>
              <span>= sin datos histricos para este perodo  se us precio de compra como base.</span>
            </div>
          )}
          </>);})()}
        </div>
      ...
      {(!isMobile||mobileSection==="retornos")&&<>{/* Retornos diarios  versin legible */}
      <div style={{...card,padding:"16px 20px"}}>
        {sectionTitle("Estadsticas de retornos diarios")}
        {(()=>{
          ...
          return(
            <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:isMobile?12:20}}>
              {/* Barras por rango */}
              <div>
                <div style={{fontSize:10,color:"var(--text-muted)",marginBottom:10,textTransform:"uppercase",letterSpacing:1}}>Das por rango de retorno</div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:10}}>
                <div style={{fontSize:10,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1,marginBottom:2}}>Mtricas clave</div>
                <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr":"1fr 1fr",gap:8}}>
                  {[
                    {l:"Das positivos", v:`${pos} (${pctPos}%)`, c:"var(--green)"},
                    {l:"Das negativos", v:`${neg} (${(100-parseInt(pctPos))}%)`, c:"var(--red)"},
                    {l:"Retorno promedio", v:fmtP(avg), c:pc(avg)},
                    {l:"Volatilidad anualizada", v:fmtP(volAnual), c:"var(--text-secondary)"},
                    {l:"Mejor da", v:fmtP(maxR), c:"var(--green)"},
                    {l:"Peor da", v:fmtP(minR), c:"var(--red)"},
                  ].map(({l,v,c})=>(
      ...
      {/* Correlacin entre activos  SIN filtro de perodo */}
      {(!isMobile||mobileSection==="correlacion")&&<div style={{...card,padding:isMobile?"10px 12px":"16px 20px"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:isMobile?"flex-start":"center",flexDirection:isMobile?"column":"row",gap:isMobile?6:0,marginBottom:12}}>
          {sectionTitle("Correlacin entre activos  retornos diarios")}
          <span style={{fontSize:10,color:"var(--text-muted)",fontStyle:"italic",background:"rgba(251,191,36,0.08)",border:"1px solid rgba(251,191,36,0.2)",borderRadius:5,padding:"2px 8px"}}> Usa todo el histrico  no aplica filtro</span>
        </div>
        {(()=>{
          // Correlacin usa TODO el histrico disponible  sin filtro de perodo
          ...
          // Retornos diarios sobre todo el histrico
          ...
          // Volatilidad real del portfolio (con correlaciones)  frmula matricial
          ...
          // Ratio de diversificacin: vol_ponderada / vol_portfolio (>1 = diversificacin efectiva)
          const divRatio = volWeighted>0 ? volWeighted/volPort : 1;

          // Contribucin marginal al riesgo de cada activo
          ...
          // Correlacin promedio de cada activo con el resto (diversificador = menor valor)
          ...
          // HHI de concentracin por riesgo
            ...
            <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"auto 1fr",gap:isMobile?16:24,alignItems:"start"}}>
              ...
              <div style={{overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
                ...
                <div style={{marginTop:10,display:"flex",gap:16,fontSize:10,color:"var(--text-muted)"}}>
                  <span><span style={{color:"var(--green)"}}></span> Correlacin positiva (&gt;0.7)</span>
                  <span><span style={{color:"var(--red)"}}></span> Correlacin negativa (&lt;-0.7)</span>
                </div>
              </div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:12}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:isMobile?6:8}}>
                  {(()=>{
                    // Semforo vol. portfolio: <8% verde, 8-15% amarillo, >15% rojo
                    ...
                    const volMsg   = volPort<8
                      ...
                      : volPort<15
                      ? " Volatilidad moderada  nivel aceptable pero atencin"
                    ...
                    const ratioMsg   = divRatio>1.5
                      ? " Buena diversificacin  los activos se compensan bien"
                      : divRatio>1.1
                      ? " Diversificacin moderada  podras mejorarla"
                      : " Poca diversificacin  los activos se mueven muy juntos";
                    ...
                    const kpis = [
                      {l:"Vol. portfolio", v:volPort.toFixed(1)+"%", c:volColor, msg:volMsg,
                        tip:"Cunto oscila tu cartera en conjunto por ao. Ej: 7.8% sobre US$10.000 = US$780 en un ao tpico."},
                      {l:"Vol. sin diversif.", v:volWeighted.toFixed(1)+"%", c:"var(--text-secondary)", msg:"= suma de vol. de cada activo  su peso. Siempre mayor que la real.",
                        tip:"Si todos tus activos cayeran al mismo tiempo (el peor caso), esta sera la volatilidad. La diferencia con Vol. Portfolio muestra cunto te protege la diversificacin."},
                      ...
                      {l:"Activos efectivos", v:nEff+" / "+activos.length, c:nEffColor, msg:nEffMsg,
                        tip:"Cuntos activos realmente distintos tens. Si tens 4 CEDEARs muy correlacionados, se cuentan casi como 1."},
                    ];
                ...
                {/* Contribucin al riesgo por activo  ordenado de mayor a menor */}
                <div>
                  <div style={{fontSize:10,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1,marginBottom:8}}>
                    Contribucin al riesgo
                    <span style={{fontWeight:400,marginLeft:6,textTransform:"none",letterSpacing:0,fontStyle:"italic"}}> qu % del riesgo total aporta cada activo (peso  volatilidad  correlacin)</span>
                  </div>
                  ...
                  <div style={{fontSize:10,color:"var(--text-muted)",marginTop:6,fontStyle:"italic"}}>
                    * Bonos ARS (TZX27, TZXD6): su volatilidad en pesos se diluye al convertir a USD por CCL, por eso su contribucin es baja aunque el precio en ARS vare.
                  </div>
                </div>
...
function FlujoTab({port, trades, bondFlows, setBondFlows, card, fxRate, historicos, isMobile=false}) {
  ...
  const [editingRowIds, setEditingRowIds] = useState(null); // ids de flows que se estn editando
  ...
  // CER: serie histrica {date:string, valor:number}[], cacheada en memoria
  ...
  // Feriados argentinos: {ao: Set<'YYYY-MM-DD'>}
  const [feriados, setFeriados] = useState({});
  const feriadosRef = React.useRef({});

  // Buscar el ltimo CER conocido <= dateStr (si no hay, devuelve el ms antiguo disponible)
  const getCER = (serie, dateStr) => {
    ...
    // Si no hay dato anterior, devolver el ms antiguo conocido
    return serie[0].valor;
  };

  // Fetch feriados de un ao desde argentinadatos
  ...
  // Restar N das hbiles a una fecha (lunes-viernes, excluyendo feriados AR)
  ...
  // Versin sincrnica con feriados ya cargados en cache
  ...
  // CER de 10 das hbiles antes de una fecha
  // Si fecha-10hd es futura  usar CER de (hoy - 10 das hbiles)
  const getCERMinus10 = (serie, dateStr) => {
    ...
    // Si la fecha de referencia an no lleg, usar hoy - 10 das hbiles
  ...
  // Pre-cargar feriados de los aos relevantes al montar
  useEffect(()=>{
  ...
  // Para cada cupn: inters = tasa  (CER_pago/CER_base)  VN_original  das/base
  // Para amort: monto = (CER_pago/CER_base)  amort_original
  // cerBase = CER del da 10 das antes de emisionDate
  const calcFlujoCER = (flow, vnOriginal, cerBase, cerPago, tna, base, dias) => {
    ...
    if(flow.tipo==='amortizacion'){
      ...
      // Inters = tna  dias/base  VN ajustado
  ...
  //  Helpers de clculo 
  // Das 30/360: convencin ICMA/Bond
  ...
  const recalcularFuturos = (ticker, flows, tna, base) => {
    ...
    // Fechas ordenadas nicas para calcular das
  ...
  const addNewFlow = () => {
    ...
    // Fecha anterior para calcular das
  ...
  // Guarda edicin de una fila existente (reemplaza los flows con los mismos IDs)
  const saveEditFlow = () => {
  ...
  //  Prximos pagos  todos los pagos futuros de todos los bonos, ordenados cronolgicamente
    ...
    return Object.values(byDate)
      ...
      .map(r=>{
        ...
        if(isCER && cerBase){
          ...
          // Para inters CER usamos una aproximacin: monto%  coef  qty/100
  ...
  const buildRows = (flows) => {
    ...
    return rows.map((row,i) => {
      ...
      // Das: usar dateCalc (terica) para el clculo, no la fecha de pago
  ...
  return (
    ...
    <div style={{display:'flex',flexDirection:'column',gap:16}}>
      ...
      {(()=>{
        ...
        // Da de semana del 1ero (0=Dom, ajustar a Lun=0)
        const startDow = (firstDay.getDay()+6)%7;
        const daysInMonth = lastDay.getDate();
        const DAYS = ['Lun','Mar','Mi','Jue','Vie','Sb','Dom'];
        ...
        // Celdas del calendario: blancos antes + das del mes
        const cells = [];
          ...
          <div style={{...card,padding:isMobile?'10px 12px':'16px 20px',display:'grid',gridTemplateColumns:isMobile?'1fr':'1fr 300px',gap:isMobile?12:20,maxHeight:isMobile?'none':390,overflow:isMobile?'visible':'hidden'}}>
            ...
            <div>
              ...
              <div style={{display:'flex',gap:16,marginTop:12,fontSize:10,color:'var(--text-muted)'}}>
                <div style={{display:'flex',alignItems:'center',gap:4}}><div style={{width:7,height:7,borderRadius:'50%',background:'var(--accent)'}}/> Cupn</div>
                              ...
                              <div style={{flex:1,minWidth:0}}>
                                <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:2}}>
                                  ...
                                  <span style={{fontSize:9,color:p.hasAmort?'var(--yellow)':'var(--accent)'}}>
                                    {p.hasAmort&&p.hasCupon?'Amort.+Cupn':p.hasAmort?'Amort.':'Cupn'}
                                  </span>
        ...
        {selected&&selBond&&(
          <div>
              ...
              <div style={{display:'flex',gap:8,alignItems:'center',flexWrap:'wrap'}}>
                ...
                {editingMeta ? (
                  <div style={{display:'flex',gap:8,alignItems:'center',background:'var(--bg-input)',border:'1px solid var(--accent)',borderRadius:8,padding:'6px 12px'}}>
                    <span style={{fontSize:11,color:'var(--text-muted)'}}>Cupn:</span>
                    ...
                    {adjustsBy==='CER'&&<>
                      <span style={{fontSize:11,color:'var(--text-muted)',marginLeft:8}}>Emisin:</span>
                  ...
                  <div style={{display:'flex',gap:6,alignItems:'center',background:'var(--bg-input)',border:'1px solid var(--border)',borderRadius:8,padding:'6px 12px',cursor:'pointer'}}
                    ...
                    <span style={{fontSize:12,color:'var(--text-secondary)'}}>Cupn <b style={{color:'var(--accent)'}}>{selMeta.tna}%</b></span>
                    <span style={{fontSize:10,color:'var(--text-muted)'}}></span>
                    <span style={{fontSize:12,color:'var(--text-secondary)'}}>Base <b style={{color:'var(--text-primary)'}}>{selMeta.base}</b></span>
                    {adjustsBy==='CER'&&<><span style={{fontSize:10,color:'var(--text-muted)'}}></span><span style={{fontSize:12,color:'var(--text-secondary)'}}>Emisin <b style={{color:'var(--yellow)'}}>{selMeta.emisionDate?fmtD(selMeta.emisionDate):''}</b></span></>}
            ...
            {adjustsBy==='CER'&&(()=>{
              ...
              // Fecha efectiva del CER base (10d antes de emisin)
              ...
              return(
                <div style={{background:'rgba(251,191,36,0.06)',border:'1px solid rgba(251,191,36,0.2)',borderRadius:8,padding:'8px 14px',marginBottom:10,display:'flex',alignItems:'center',gap:16,flexWrap:'wrap',fontSize:11}}>
                  ...
                  {!cerSerie&&<span style={{color:'var(--text-muted)'}}> Esperando datos del histrico  el script Python actualiza el CER diariamente</span>}
                  {cerSerie&&!emisionDate&&<span style={{color:'var(--text-muted)'}}>Edit el chip  para ingresar la fecha de emisin</span>}
            ...
            {addingFlow===selected&&(
              <div style={{background:editingRowIds?'rgba(96,165,250,0.06)':'rgba(59,130,246,0.06)',border:`1px solid ${editingRowIds?'rgba(96,165,250,0.3)':'rgba(59,130,246,0.15)'}`,borderRadius:10,padding:'14px 16px',marginBottom:12,display:'flex',gap:10,alignItems:'flex-end',flexWrap:'wrap'}}>
                {editingRowIds&&<div style={{width:'100%',fontSize:11,color:'#60A5FA',fontWeight:600,marginBottom:2}}> Editando fila  modific los campos y guard</div>}
                {/* F. Pago */}
                ...
                {/* F. Terica */}
                <div style={{display:'flex',flexDirection:'column',gap:4,minWidth:130}}>
                  <span style={{fontSize:10,color:'var(--text-muted)'}}>F. Terica (clculo)</span>
                ...
                <div style={{display:'flex',flexDirection:'column',gap:4,minWidth:140}}>
                  ...
                  <select value={newFlow.tipo} onChange={e=>setNewFlow(p=>({...p,tipo:e.target.value}))} style={inp}>
                    <option value="cupon"> Solo cupn</option>
                    <option value="amortizacion"> Solo amort.</option>
                    <option value="ambos">+ Amort.+Cupn</option>
                  </select>
                </div>
                {/* Amort */}
                ...
                {/* Cupn  editable si modo edicin, calculado si modo nuevo */}
                {(newFlow.tipo==='cupon'||newFlow.tipo==='ambos')&&(
                  <div style={{display:'flex',flexDirection:'column',gap:4,minWidth:110}}>
                    <span style={{fontSize:10,color:'var(--text-muted)'}}>{editingRowIds?'Cupn % VN':'Inters calculado'}</span>
                    {editingRowIds
            ...
            {rows.length===0
              ? <div style={{color:'var(--text-muted)',fontSize:13,padding:'20px 0'}}>No hay flujos. Us "+ Agregar pago" para cargarlos.</div>
              : (<>
                {/* Toggle vista */}
                ...
                {viewMode==='prospecto'&&(()=>{
                  ...
                  // CER base = ltimo CER conocido 10 das antes de la emisin
                  ...
                  <div style={{overflowX:'auto',borderRadius:10,border:'1px solid var(--border)'}}>
                    <table style={{width:'100%',borderCollapse:'collapse',fontSize:12}}>
                      <thead>
                        <tr>
                          ...
                          <th style={{...thPL,color:'var(--text-muted)',fontSize:9}}>F. Terica</th>
                          <th style={thP}>Das ({selMeta.base})</th>
                          <th style={thP}>Amort. % VN</th>
                          <th style={thP}>VN Residual</th>
                          <th style={thP}>Cupn</th>
                          <th style={thP}>Inters % VN</th>
                          {isCERBond&&<><th style={{...thP,background:'rgba(251,191,36,0.06)',color:'var(--yellow)'}}>CER</th><th style={{...thP,background:'rgba(251,191,36,0.06)',color:'var(--yellow)'}}>VN Ajust.</th><th style={{...thP,background:'rgba(251,191,36,0.06)',color:'var(--yellow)'}}>Inters Aj.</th></>}
                          <th style={{...thP,background:'rgba(251,191,36,0.1)',color:'var(--yellow)'}}>Amort.</th>
                          <th style={{...thP,background:'rgba(59,130,246,0.1)',color:'var(--accent)'}}>Inters</th>
                      ...
                      <tbody>
                        {rows.map((row,i)=>{
                          ...
                          // getCER devuelve el ltimo valor conocido <= fecha (o el ms antiguo si no hay anterior)
                          // CER de pago = CER de (fecha_pago - 10 das hbiles), o (hoy - 10hd) si es futuro
                          ...
                          return(
                            <tr key={row.date} style={{background:rowBg}}>
                              ...
                              {/* Inters  input siempre visible, estilo texto hasta focus */}
                    ...
                    <div style={{fontSize:9,color:'var(--text-muted)',padding:'6px 10px'}}>
                      ...
                      {isCERBond&&!cerSerie?'  Carg la serie CER para ver columnas ajustadas':''}
                    </div>
                  </div>
                  );
                })()}
                  ...
                  <table style={{width:'100%',borderCollapse:'collapse',fontSize:13}}>
                    ...
                    <tbody>
                      {rows.map(row=>{
                        ...
                        // Amortizacin: monto%  VN ajustado  qty/100
                        ...
                        if(isCERRow && coefCERRow){
                          ...
                          // Inters: sobre VN ajustado antes del pago
                        ...
                        const tipoLabel = hasAmort&&hasCupon?'+ Amort.+Cupn':hasAmort?' Amort.':' Cupn';
    ...
    {/* BondWizard inline  carga rpida desde FlujoTab */}
...
function App(){
  ...
  const SEED_TRADES = [
    ...
    {id:9, ticker:"FIMA-PREMD",tipo:"compra", qty:140,      price:1.012932,  currency:"USD", date:"2026-01-01", ts:9000,  name:"FIMA Premium Dlares Cl A",       comision:0},
    //  Operaciones 2026 
    // GLD
  ...
  // Cargar histricos desde JSON generado por GitHub Actions
  useEffect(()=>{
  ...
  const saveToGitHub = async (newPort, newTrades, newFlows, newMeta) => {
    try{
      ...
      if(res.ok){
        ...
        setSyncStatus("idle"); // reintentar en el prximo save
      } else {
  ...
  useEffect(()=>{
    // 0. Generar device ID nico para este dispositivo
    ...
    // 2. Cargar desde /api/sync  SOLO si localStorage est vaco (dispositivo nuevo)
    ...
    fetch('/api/sync')
      ...
      .then(data=>{
        ...
        // Aplicar si: no tengo datos locales, O si GitHub es ms nuevo Y fue otro dispositivo
  ...
  const lastSyncRef = React.useRef(0); // timestamp del ltimo sync exitoso
  useEffect(()=>{
    ...
    saveTimerRef.current = setTimeout(()=>{
      ...
      // Solo guardar si este save es ms nuevo que el ltimo sync
  ...
  // Refresh al cargar  esperar que localStorage est listo
  ...
  const en = useMemo(()=>port.map(h=>{
    ...
    if(livePrice && historicos){
      ...
      if(bars && bars.length>=1){
        ...
        // Sin histrico: si fue dado de alta hoy, variacin vs PPC de compra
    ...
    // costUSD: sumar cada lote de compra al TC de ese da + comisiones
    let costUSD;
    if(h.buyCurrency==="USD"){
      const buyLots = trades.filter(t=>t.ticker===h.ticker&&t.tipo==="compra");
  ...
  // TWR anualizado + P&L real por ao
  const twrStats = useMemo(()=>{
    ...
    // (no necesitamos cada da del calendario, solo los das con barras de precio)
    ...
    // Helper: convertir monto en moneda a USD usando CCL de esa fecha  biseccin
    const cclCacheT={};
    const getCCLT=(date)=>{
    ...
    // P&L por ao: solo TWR % por ao
    // El P&L en USD total lo calculamos desde pnlRealizado + totPnl (ms confiable)
    const years = [...new Set(allDates.map(d=>d.slice(0,4)))];
    const byYear = {};

    // P&L realizado por ao (ventas FIFO en USD, por ao de la venta)
    ...
    years.forEach(y=>{
      ...
      // P&L USD del ao = realizado en el ao + cambio en valor de cartera
      // Para el ao en curso: no realizado = totPnl (ya calculado fuera)
      // Para aos cerrados: no realizado = 0 (todo fue realizado o rolado)
  ...
  // para que el script descargue histrico completo sin perder datos de posiciones cerradas
  ...
  const saveOrDelete=(h)=>{
    ...
    if(newTickers.length>0){
      ...
      // portfolio_tickers.json se descarga manualmente desde el botn CSV
  ...
  const downloadTrades=()=>{
    ...
    const header=["Fecha","Ticker","Nombre","Tipo","Nominales","Precio","Moneda","Monto Bruto","Comisin","Monto Neto","PnL Monto","PnL %"].join(sep);
  ...
  useEffect(()=>{
    ...
    (async()=>{
      ...
      try{
        ...
        // CER como proxy de inflacin ARS
    ...
    <>
      ...
      <div style={{minHeight:"100vh",background:"var(--bg)",color:"var(--text-primary)",overflowX:"hidden",maxWidth:"100vw"}} className={darkMode?"theme-dark":"theme-light"}>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
            ...
            <div style={{display:"flex",gap:6,alignItems:"center",flexShrink:0}}>
              {!isMobile&&<div style={{display:"flex",flexDirection:"column",gap:1}}>
                ...
                <div style={{fontSize:9,color:"var(--text-muted)",textAlign:"center"}}>dlar de valuacin</div>
              </div>}
              ...
              <button onClick={()=>setModal("add")} style={{background:"var(--accent)",border:"none",borderRadius:6,padding:"6px 12px",color:"#fff",cursor:"pointer",fontSize:isMobile?12:13,fontWeight:600}}>+ Posicin</button>
            </div>
          </div>
        ...
        <div style={{background:"var(--bg-card)",borderBottom:"1px solid var(--border)",padding:"0 12px",display:"flex",gap:0,overflowX:"auto",WebkitOverflowScrolling:"touch",scrollbarWidth:"none"}}>
          {[["dashboard"," Dashboard"],["portfolio"," Portfolio"],["analisis"," Anlisis"],["flujos"," Flujos"],["operaciones"," Operaciones"]].map(([id,lbl])=>(
                    ...
                    <div key={f.id} style={{background:'rgba(251,191,36,0.08)',border:'1px solid rgba(251,191,36,0.25)',borderRadius:10,padding:'12px 16px',display:'flex',alignItems:'center',justifyContent:'space-between',gap:12}}>
                      <div style={{display:'flex',alignItems:'center',gap:10}}>
                        ...
                        <div>
                          ...
                          <span style={{color:'var(--text-secondary)',fontSize:12,marginLeft:8}}>{f.tipo==='amortizacion'?'Amortizacin':'Cupn'}  {f.date?.slice(8)+'/'+f.date?.slice(5,7)+'/'+f.date?.slice(0,4)}</span>
          ...
          {tab==="dashboard"&&(
            <div className="fi" style={{display:"grid",gap:16}}>
              ...
              {(()=>{
                ...
                // Esto es ms preciso que comparar con el ltimo bar del historicos.json
                const todayKPI=todayAR();
                let dayPnlUSD=0, baseValUSD=0;
                for(const h of en){
                  // Solo activos con precio live y cambio % del da
                ...
                return(
                  ...
                  {proxVto&&(
                    <div style={{background:"var(--bg-card)",border:"1px solid var(--border)",borderLeft:"3px solid var(--yellow)",borderRadius:10,padding:"16px 20px",display:"flex",flexDirection:"column",justifyContent:"center",gap:6,minWidth:160}}>
                      <span style={{fontSize:9,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1.2,fontWeight:600}}>Prx. vencimiento</span>
                      ...
                      <span style={{fontSize:11,color:"var(--text-muted)"}}>{Math.round((new Date(proxVto.date)-new Date(todayKPI))/(1000*60*60*24))} das</span>
                    </div>
                  )}
                  </div>
                );
              ...
              <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"220px 1fr",gap:14,alignItems:"stretch"}}>
                <div style={{...card,padding:"18px 16px",display:"flex",flexDirection:"column"}}>
                  <div style={{fontSize:9,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1.2,marginBottom:12,fontWeight:600}}>Asignacin por tipo</div>
              ...
              {twrStats&&Object.keys(twrStats.byYear||{}).length>0&&(()=>{
                ...
                const BAR_MAX = 80; // px altura mxima de barra
                return(
                <div style={{...card,padding:"20px 24px"}}>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:24}}>
                    <div>
                      ...
                      <div style={{fontSize:10,color:"var(--text-muted)",marginTop:2,opacity:0.7}}>Incluye activos ya vendidos  punta a punta por ao calendario</div>
                    </div>
                    <div style={{display:"flex",gap:20,alignItems:"center"}}>
                      <div style={{textAlign:"right"}}>
                        ...
                        <div style={{fontSize:18,fontWeight:700,color:pc(twrStats.twrAnual),fontFamily:"'DM Mono',monospace"}}>
                          {twrStats.twrAnual>=0?"+":""}{twrStats.twrAnual.toFixed(1)}%<span style={{fontSize:11,fontWeight:400,opacity:0.6}}>/ao</span>
                        </div>
                      </div>
                      <div style={{textAlign:"right"}}>
              ...
              {/* Top/Bottom 5 del da en Dashboard */}
        ...
        <div className={darkMode?"theme-dark":"theme-light"} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.82)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300}}>
          <div style={{background:"var(--bg-card)",border:"1px solid var(--border)",borderRadius:16,padding:28,width:460,maxWidth:"95vw",maxHeight:"90vh",overflowY:"auto"}}>
            ...
            {(()=>{
              ...
              const benchmarks=[
                {label:"Tu operacin",val:ventaResult.pnlPct,color:ventaResult.pnlPct>=0?"var(--green)":"var(--red)",bold:true},
                // T10Y: solo USD
                ...
                // CCL y MEP: siempre (son benchmarks tiles en ambas monedas)
                {label:"Dlar CCL",val:bd?.cclPct??null,color:"#A78BFA"},
                {label:"Dlar MEP",val:bd?.mepPct??null,color:"#818CF8"},
                // CER (inflacin ARS): siempre
                {label:"Inflacin ARS (CER)",val:bd?.infArPct??null,color:"#F97316"},
              ];
              ...
              return(
                <div style={{background:"var(--bg-input)",borderRadius:12,padding:"14px 16px"}}>
                  <div style={{fontSize:11,color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:1,marginBottom:12,display:"flex",justifyContent:"space-between"}}>
                    <span>vs benchmarks  {Math.round(days)} das</span>
